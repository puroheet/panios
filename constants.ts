...
export const APP_DEFINITIONS_CONFIG: AppDefinition[] = [
  ...
  {id: 'clock_app', name: 'Clock', icon: '⏰', color: '#fff9c4'},
];
...
0.  **Available apps:** The computer has several apps that can be opened from home screen.
    ...
    - "Clock": Displays a live digital clock. You MUST generate the necessary HTML and a \`<script>\` tag to update the time every second.
        - Example HTML: \`<div id="clock-display" class="llm-title" style="font-size: 4rem; text-align: center; padding: 3rem; font-family: monospace;"></div>\`
        - Example Script:
          \`\`\`html
          <script>
            (function() {
